...
//
//    private ReporteEntity modelEntity;
//
//    @BeforeEach
//    void setUp() {
...
//        ReporteEntity modelEntityUnderTest = new ReporteEntity("id", "atr1");
//
...
//        when(mapper.map(modelEntity, ReporteEntity.class)).thenReturn(modelEntity);
//
